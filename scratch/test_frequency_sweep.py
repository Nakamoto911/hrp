...
from app import run_rebalance_frequency_sweep
...
def test_sweep():
    ...
    print("Running rebalance frequency sweep...")
    df = run_rebalance_frequency_sweep(prices_df, params, "european", 100000.0)
    print(df.to_string())
