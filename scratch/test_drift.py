...
thresholds = [0.0, 0.005, 0.015, 0.03, 0.05]
for t in thresholds:
    ...
    print(f"Drift Threshold: {t*100:4.1f}% | Return: {metrics['annualized_return']*100:5.2f}% | Vol: {metrics['annualized_volatility']*100:5.2f}% | Sharpe: {metrics['sharpe_ratio']:.2f} | TC Paid: {hrp_diag['total_friction_costs_paid']:6.2f} EUR")
