...
# Load cache
df = pd.read_csv("cache/etf_prices.csv", index_col=0, parse_dates=True)
...
hrp_cum, hrp_diag, _, _, _ = run_strategy_backtest(df, params, 'etf')
...
prices_bt = df.loc[backtest_start:]

# Compute annualized return and volatility of each asset
asset_ann_returns = {}
...
print("AVERAGE HRP WEIGHTS AND ASSET PERFORMANCE IN ETF POOL:")
